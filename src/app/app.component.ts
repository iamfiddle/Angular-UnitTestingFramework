...
export class AppComponent {
  ...
  OnPost() {
    ...
    this.apiService.PostRequest("/Books", this.messageBody, () => { console.log("This Callback sould be executed") }).subscribe(
      result => {
  ...
  OnDelete() {
    this.apiService.DeleteRequest("/Books", 4, () => { console.log("This Callback should be called") }).subscribe(
